...
for n in range(0,10,1):
    ...
    ax_current.plot(np.arange(1993.5,2021.1,1/12),al_oras5[:,n], "orange")
   # ax_current.plot(np.arange(1993.5,2021.05,1/12),allsat_nemo[:,n], "g-")
    ax_current.plot(np.arange(1993.5,2021.05,1/12),allsat_oras5[:,n], 'g-')
    #ax_current.plot(np.arange(1993.5,2021.51,1/12),jpl_nemo[:,n], "plum")
    #ax_current.plot(np.arange(1993.5,2021.05,1/12),allsat_oras5[:,n], "skyblue",laebl='cnes by oras5')
    ax_current.plot(np.arange(1993.5,2021.51,1/12),jpl_oras5[:,n], 'orchid')
...
# =============================================================================
fig.savefig('/Users/qi/Dropbox/Results_chapter1/paper_codes/sup08.png',dpi=150, bbox_inches ='tight')
# =============================================================================
